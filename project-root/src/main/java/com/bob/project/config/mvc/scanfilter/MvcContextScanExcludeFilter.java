 ...
 */
package com.bob.project.config.mvc.scanfilter;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import com.bob.project.config.mvc.timer.TimerContextConfig;
...
public class MvcContextScanExcludeFilter extends AbstractClassTestingTypeFilter {
    ...
    static {
        List<Class<?>> excludeConfigClasses = Arrays.asList(AppUserContextConfig.class, TimerContextConfig.class);
