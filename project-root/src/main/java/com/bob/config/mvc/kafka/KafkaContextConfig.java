 ...
 *
 */
package com.bob.config.mvc.kafka;
...
import com.bob.config.mvc.kafka.constant.KafkaContextConstant;
import com.bob.config.mvc.kafka.factoryconfig.KafkaContainerFactoryConfigurar;
...
public class KafkaContextConfig {
	...
	public KafkaTemplate<Integer, String> defaultafKaTemplate() {
		...
		kafkaTemp.setDefaultTopic(KafkaContextConstant.KAFKA_TOPIC);
		return kafkaTemp;
	}
