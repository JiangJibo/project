...
public class AspectPointcutConfig {
	 ...
	 * @param joinpoint
	 */
	@After("execution(public * com.bob.test.concrete.cglibproxy.ProxiedModel.*(..))")
	 ...
	 * @param joinpoint
	 */
	@Before("@args(com.bob.config.mvc.userenv.ann.UserEnv)")
	 ...
	 * @throws Throwable
	 */
	@Around("@annotation(com.bob.config.mvc.userenv.ann.UserEnv)")
	 ...
	 * @param ex
	 */
	@AfterThrowing(value = "this(com.bob.test.concrete.cglibproxy.ProxiedModel)", throwing = "ex")
