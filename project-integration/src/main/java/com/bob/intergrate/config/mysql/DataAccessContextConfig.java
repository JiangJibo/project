package com.bob.intergrate.config.mysql;

import java.util.Map;

import javax.sql.DataSource;

import com.bob.intergrate.config.mysql.readasepwrite.DataSourceTransactionManagerAdapter;
import com.bob.intergrate.config.mysql.readasepwrite.DynamicDataSource;
