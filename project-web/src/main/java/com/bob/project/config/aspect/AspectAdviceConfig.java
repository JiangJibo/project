 ...
 *
 */
package com.bob.project.config.aspect;

import java.lang.annotation.Annotation;
import java.lang.reflect.Method;

import com.bob.project.config.userenv.ann.UserEnvAnnotationProcessor;
...
public class AspectAdviceConfig {
	 ...
	 * @throws Exception
	 */
	@Before("com.bob.project.config.aspect.AopArchitecture.serviceMethod()")
	 ...
	 * @param retVal
	 */
	@AfterReturning(pointcut = "com.bob.project.config.aspect.AopArchitecture.serviceMethod()", returning = "retVal")
