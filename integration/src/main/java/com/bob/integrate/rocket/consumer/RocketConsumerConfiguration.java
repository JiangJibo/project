package com.bob.integrate.rocket.consumer;
...
import com.bob.integrate.rocket.consumer.failurehandler.DefaultConsumeFailureHandler;
...
public class RocketConsumerConfiguration {
     ...
     */
    //@RocketListener(configProperties = "rocket-concurrently-config.properties", failureHandler = "defaultConsumeFailureHandler")
