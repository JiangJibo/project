package dubbo.remoting.zookeeper;
...
public class ZookeeperTransporter$Adaptive implements ZookeeperTransporter {
    ...
    public ZookeeperClient connect(URL arg0) {
        ...
        if (extName == null) {
            throw new IllegalStateException("Fail to get extension(com.alibaba.dubbo.remoting.zookeeper.ZookeeperTransporter) name from url(" + url.toString()
